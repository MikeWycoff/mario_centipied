...
class LilCenti(pygame.sprite.Sprite):
    ...
    def __init__(self,x,y):
        ...
        self.imgSize=(20,20)
        self.image=pygame.image.load("images/pokey_head2.png")
        self.gif.append(pygame.image.load("images/pokey_head2.png"))
        self.gif.append(pygame.image.load("images/pokey_body2.png"))
