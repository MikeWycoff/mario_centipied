...
class Goomba(pygame.sprite.Sprite):
    ...
    def __init__(self):
        ...
        self.imgSize=(40,20)
        self.image=pygame.image.load("images/goomba1.png")
        self.gif.append(pygame.image.load("images/goomba1.png"))
        self.gif.append(pygame.image.load("images/goomba2.png"))
